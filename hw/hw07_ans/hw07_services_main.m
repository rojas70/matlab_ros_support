...
if strcmp(type,'gazebo')
    ...
    for i=1:n
        ...
        fprintf("The pose position (xyz) is: [ %0.2f, %0.2f, %0.2f ]\n", ...
            model_name.Pose.Position.X, model_name.Pose.Position.Y, model_name.Pose.Position.Z);

        % Print the ROS quaternion for the model xyzw
        fprintf("The pose quaternion (xyzw) is: [ %0.2f, %0.2f, %0.2f, %0.2f ]\n", ...
            model_name.Pose.Quaternion.W, model_name.Pose.Quaternion.X, model_name.Pose.Quaternion.Y, model_name.Pose.Quaternion.Z);
